...
//    }
    ...
    func authenticateUserProfile(email: String, phoneNumber: String, nimNumber: String, university: String, location: String , request_goods: String ) {
        ...
        if !isValidEmail{
            ...
            userModel = UserModels(user_id: "", name: "", phone_number: phoneNumber, email: email, password: "", confirmPassword: "", nim: nimNumber, entryYear: "", university: university, location: location, student_card: "", request_goods: request_goods)
